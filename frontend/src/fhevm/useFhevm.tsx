...
export type FhevmDetailedStatus = "idle" | "sdk-loading" | "sdk-loaded" | "sdk-initializing" | "sdk-initialized" | "creating" | "ready" | "error";
...
export function useFhevm(parameters: {
  ...
  status: FhevmGoState;
  detailedStatus: FhevmDetailedStatus;
} {
  ...
  const [detailedStatus, _setDetailedStatus] = useState<FhevmDetailedStatus>("idle");
  ...
  useEffect(() => {
    ...
    if (_isRunning === true) {
      ...
      _setStatus("loading");
      _setDetailedStatus("sdk-loading");
      _setError(undefined);
      ...
      createFhevmInstance({
        ...
        onStatusChange: (s) => {
          ...
          _setDetailedStatus(s as FhevmDetailedStatus);
        },
      })
        .then((i) => {
        ...
        .catch((e) => {
          ...
          _setError(e);
          _setStatus("error");
          _setDetailedStatus("error");
        });
    }
  }, [_isRunning, _providerChanged]);

  return { instance, refresh, error, status, detailedStatus };
}
